 ...
 */
final class Version20260126204809 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE coach (id INT AUTO_INCREMENT NOT NULL, pseudo VARCHAR(50) NOT NULL, email VARCHAR(100) NOT NULL, type VARCHAR(20) NOT NULL, bio LONGTEXT DEFAULT NULL, experiences VARCHAR(100) DEFAULT NULL, nationality VARCHAR(50) DEFAULT NULL, languages VARCHAR(100) DEFAULT NULL, user_id INT NOT NULL, UNIQUE INDEX UNIQ_3F596DCCA76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(50) NOT NULL, email VARCHAR(100) NOT NULL, password VARCHAR(50) NOT NULL, role VARCHAR(50) NOT NULL, status VARCHAR(50) DEFAULT NULL, registration_date DATE NOT NULL, coin INT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
